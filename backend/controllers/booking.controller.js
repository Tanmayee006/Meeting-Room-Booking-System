...
const cancelBooking = async (req, res) => {
  try {
    ...
    return res.status(200).json(new ApiResponse(200, result, "Booking cancelled successfully", true));
  } catch (error) {
...
const completeBooking = async (req, res) => {
  try {
    ...
    return res.status(200).json(new ApiResponse(200, result, "Booking marked as completed", true));
  } catch (error) {
